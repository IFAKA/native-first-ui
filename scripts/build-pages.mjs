...
const pageCss = transform({ filename: "pith.css", code: Buffer.from(pageSource), minify: true, drafts: { nesting: true }, targets: { chrome: 110 << 16, firefox: 110 << 16, safari: 16 << 16 } }).code;
await writeFile(new URL("pith.css", output), pageCss);
