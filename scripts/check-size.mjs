...
const files = ["core.css", "layout.css", "forms.css", "navigation.css", "data.css", "overlays.css"];
...
const project = await readFile(new URL("project.css", root));
if (size(project, "br") > 1024) throw new Error(`project.css exceeds the 1 KB Brotli budget (${size(project,"br")} B)`);
