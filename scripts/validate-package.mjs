...
for (const recipe of ["dialog","drawer","data-table","menu"]) for (const file of ["snippet.html","README.md","metadata.json"]) await readFile(new URL(`recipes/${recipe}/${file}`, root));
